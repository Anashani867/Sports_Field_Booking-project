                    ...
                    <ul class="widget-newsdetails clearfix">
                        <li class=clearfix><a href="#" class=clearfix>
                                <div class=widget-pic
                                     style="background:url({{asset('assets')}}images/widget/widget01.jpg) center no-repeat"></div>
                        ...
                        <li class=clearfix><a href="#" class=clearfix>
                                <div class=widget-pic
                                     style="background:url({{asset('assets')}}images/widget/widget02.jpg) center no-repeat"></div>
                                <div class=widget-newsinfo><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                        Numquam soluta excepturi.</p>
                        ...
                        <li class=clearfix><a href="#" class=clearfix>
                                <div class=widget-pic
                                     style="background:url({{asset('assets')}}images/widget/widget03.jpg) center no-repeat"></div>
                                <div class=widget-newsinfo><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                        Numquam soluta excepturi.</p>
