...
<style>
    ...
    .blogimg img {
        display: block; /* لمنع المسافة الافتراضية تحت الصورة */
        width: 100%;
        height: 450px;
        object-fit: cover;
    }
    ...
    .blog_info {
        ...
        padding-top: 15px; /* إضافة تباعد داخلي بدلاً من الهامش */
    }

    /* لإزالة أي مسافات إضافية */
    .clearfix {
        display: flex;
    ...
    /* للتأكد من عدم وجود مسافات بين العناصر */
    .headlineimgwrap01,
    .headlinewrap01 {
        margin: 0;
        padding: 0;
...
{{--            <input type="file" name="media" id="media" accept="image/*, video/*" class="form-control">--}}
{{--        </div>--}}

{{--        <div class="form-group">--}}
{{--            <label for="title">Enter Title:</label>--}}
{{--            <input type="text" name="title" id="title" class="form-control" placeholder="Enter a custom title" required>--}}
{{--        </div>--}}
...
{{--    </form>--}}
    ...
    <form action="{{ route('media.upload') }}" method="POST" enctype="multipart/form-data" class="upload-form">
        @csrf
        <div class="form-group">
            <label for="media">Upload Media:</label>
    ...
    <section class="innerpage_all_wrap bg-white">
        <div class="container">
            <div class="row">
                <h2 class="heading">This is Our <span>Blog</span></h2>

                <p class="headParagraph">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat quisquam reprehenderit, blanditiis nam debitis libero facilis illum repudiandae eveniet voluptatibus quibusdam illo ea nisi ipsa accusantium nobis animi asperiores quaerat.
                </p>
                    ...
                    <main class="contentinner">
                        @foreach($media as $item)
                            <div class="blogDetails">
                                <div class="blogimg">
                                    @if($item->type === 'image')
                                        <img src="{{ asset('storage/' . $item->path) }}" alt="Image" style="max-width: 100%; height: auto;"/>
                                    @elseif($item->type === 'video')
                                        <video controls>
                                            <source src="{{ asset('storage/' . $item->path) }}" type="{{ $item->type }}">
                                        </video>
                                    @endif
                                </div>
                                ...
                                <div class="blog_info">
                                    <div class="clearfix">
                                        <div class="headlineimgwrap01">
                                            <img src="{{ asset('assets/images/icons/video.png') }}" alt="image"/>
                                        </div>
{{--                                        <div class="headlinewrap01">--}}
{{--                                            <h4 class="headline02">The Best <span class="red">Moments</span> in the Seasons</h4>--}}
{{--                                            <p class="paragraph02 uppercaseheading">--}}
{{--                                                {{ $item->created_at->format('F d, Y h:i A') }}--}}
{{--                                            </p>--}}
                                        <div class="headlinewrap01">
{{--                                            <h4 class="headline02">{{ $item->title }}</h4> <!-- عرض العنوان -->--}}
                                            <h4 class="headline02">
                                                {!! str_replace('Moments', '<span class="red">Moments</span>', $item->title) !!}
                                            </h4>
                                            <p class="paragraph02 uppercaseheading">
                                                {{ $item->created_at->format('F d, Y h:i A') }}
                                            </p>
